...
class RecommenderModel:
    ...
    def load_train_data(self, data_directory):
        ...
        self.interactions_df = pd.read_csv(os.path.join(data_directory, 'user_interactoins.csv'))
    ...
    def preprocess_data(self, k1=1.2, b=0.75):
        ...
        self.train_data = sparse_content_person.tocsr()
    ...
    def predict(self, user_index, n_predict=10):
        """
        """
        user_data = self.train_data.T.tocsr()
        return self.model.recommend(user_index, user_data, N=n_predict)
